...
const hashing_service_base_1 = require("src/shared/hashing/hashing.service.base");
let UserService = class UserService {
    ...
    getByUsernameAndId(username, id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.userRepository.createQueryBuilder('user')
...
UserService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_2.InjectRepository(user_domain_1.User)),
